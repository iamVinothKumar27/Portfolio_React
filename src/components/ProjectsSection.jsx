          ...
          {filteredProjects.map((project, index) => (
            ...
            >
              <div className="relative overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-black/50 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center gap-4 z-10">
                  {project.liveUrl && (
                    <motion.a
